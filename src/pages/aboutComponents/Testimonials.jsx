  ...
  return (
    <>
        ...
        <div className="testimonials-row">
          <div className="testimonials-col">
            ...
            <div className="testimonial-quote">
              <q>
                My partner and I found our therapist through Mohala. After 2
                weeks, our relationship improved immensely and we just got
                started!
              </q>
          ...
          <div className="testimonials-col">
            ...
            <div className="testimonial-quote">
              <q>
                Fantastic educational content, achievable goals, and good
                support. It psychologically prepares you for a lifetime of
                holistic, healthy habits, and helps you recenter your mind &
                body.
              </q>
          ...
          <div className="testimonials-col">
            ...
            <div className="testimonial-quote">
              <q>
                Meals, tips, exercise, and meditation all in one place.
                Everything I need to stay accountable.
              </q>
      ...
      <Container className="bottom-container">
        <p>
          Holistic living isn’t one size fits all. We want to be your resource
          to help you create a lifestyle that nourishes you as a whole. We help
          you create a holistic lifestyle by approaching all the four pillars
